...
if (typeof(dataLayer) !== "undefined") {
  if (dataLayer) {
    dataLayer.push({ 'event': 'visitIdSet', 'visitId': '59212859' });
  }
}
...
var __ctg3 = (function(ctWindow){
  ...
  var log_pingback = function(interval){
    ...
    function pingbackAndSchedule(ua_params) {
      ...
      src_string = 'https://pendragon.calltracks.com:443/wnd/pingback.js?pid=325824478&int=' + interval + '&fk=' + encodeURIComponent(__ctwnd.rc('__utma')) + '&c=' + encodeURIComponent(__ctwnd.rc('__utmz')) + '&cv=' + encodeURIComponent(__ctwnd.rc('__utmv')) + ua_params  ;
  ...
  return {
    ...
    run: function(){
      for (var i=0;i<_ctq.length;i++){var o=_ctq[i];if(o[0]==="_unhide"){__ctg3.unhide=o[1]}}
        ...
        __ctwnd.sc(__ctwnd.infoCookieName(), 'kwid%3D%3Brefid%3D%3Bvid%3D59212859');
